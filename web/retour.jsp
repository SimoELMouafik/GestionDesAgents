...
<body>
	...
	<pre>             Matricule *                  </pre>
	<input class="boutton"  type="text" name="matric" onKeyUp="vider(this.form)" value="<%=emp.getMatricule()%>" />
	 <input  id="afficher" type="submit" name="login" value="Check" />
        <pre>Nom                          </pre>      
	<input class="boutton"  type="text" name="nom" value="<%=emp.getNom()%>"/><br />
	<pre>Prénom                       </pre>      
	<input class="boutton"  type="text" name="prenom" value="<%=emp.getPrenom()%>"/><br />
