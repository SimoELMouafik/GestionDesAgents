...
public class EnvoiPassServlet extends HttpServlet {
    ...
    {	    
     ...
     { emp = AffichageDAO.Afficher(emp);
       ...
       MailAgent.setDestinataire(emp.getEmail());
       MailAgent.setNameDest(emp.getPrenom()+" "+emp.getNom());
       MailAgent.setPassDest(emp.getPassword());
       MailAgent.mail();
       HttpSession session = request.getSession(true);	    
       session.setAttribute("employe",emp);
       response.sendRedirect("EnvoiMdp.jsp");
