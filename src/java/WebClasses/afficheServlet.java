...
public class afficheServlet extends HttpServlet {
    ...
    {	    
     ...
     { emp = AffichageDAO.Afficher(emp);        
      ...
      if(request.getParameterValues("login")[0].equals("Chercher l'Agent")) 
              response.sendRedirect("afficherAgent.jsp"); //logged-in page
      else  response.sendRedirect("afficher.jsp");
     }  
